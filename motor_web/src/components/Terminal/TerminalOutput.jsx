...
const RichText = ({ content }) => {
  ...
  const formatSpecialText = (text) => {
    ...
    const patterns = [
      ...
      // Tags combinados (bold + color)
      { regex: /\[bold red\](.*?)\[\/bold red\]/g, style: 'color: #FF5252; font-weight: bold;' },
      { regex: /\[bold green\](.*?)\[\/bold green\]/g, style: 'color: #4CAF50; font-weight: bold;' },
      { regex: /\[bold blue\](.*?)\[\/bold blue\]/g, style: 'color: #2196F3; font-weight: bold;' },
      { regex: /\[bold yellow\](.*?)\[\/bold yellow\]/g, style: 'color: #FFC107; font-weight: bold;' },
      { regex: /\[bold purple\](.*?)\[\/bold purple\]/g, style: 'color: #9C27B0; font-weight: bold;' },
      { regex: /\[bold cyan\](.*?)\[\/bold cyan\]/g, style: 'color: #00BCD4; font-weight: bold;' },
      { regex: /\[bold white\](.*?)\[\/bold white\]/g, style: 'color: #FFFFFF; font-weight: bold;' },
      { regex: /\[bold gray\](.*?)\[\/bold gray\]/g, style: 'color: #9E9E9E; font-weight: bold;' },
      // Colores simples
