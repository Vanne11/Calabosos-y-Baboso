...
<header class="top">
  ...
  <nav>
    <?php foreach (['dashboard' => 'Panel', 'analytics' => 'Analítica', 'prompts' => 'Prompts', 'settings' => 'Ajustes', 'chats' => 'Conversaciones', 'ratings' => 'Calificaciones', 'logs' => 'Registro', 'diagnostics' => 'Diagnóstico'] as $p => $label): ?>
