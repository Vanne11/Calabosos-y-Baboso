...
final class PromptRenderer
{
     ...
     */
    const CONTEXT_VARS = ['genero', 'lleva', 'memoria', 'decisiones', 'historial_npc', 'citas', 'ya_dijiste', 'como_escribe', 'animo', 'npc_ficha', 'ficha_narrador'];
    ...
    public static function contextBlock(array $vars, string $usedText): string
    {
        $sections = [
            ...
            'lleva' => 'Lo que Alex lleva encima ahora (objetos y monedas; úsalo si viene al caso): %s',
